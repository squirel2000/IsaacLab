...
gym.register(
    id="Isaac-Velocity-Loco-G1-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.loco_env_cfg:G1LocoEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1LocoPPORunnerCfg",
        # "skrl_cfg_entry_point": f"{agents.__name__}:skrl_loco_ppo_cfg.yaml",
    },
)


gym.register(
    id="Isaac-Velocity-Loco-G1-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.loco_env_cfg:G1LocoEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1LocoPPORunnerCfg",
        # "skrl_cfg_entry_point": f"{agents.__name__}:skrl_loco_ppo_cfg.yaml",
    },
)
